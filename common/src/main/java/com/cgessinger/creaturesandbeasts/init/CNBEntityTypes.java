...
public class CNBEntityTypes {
    ...
    public static final CNBRegistrySupplier<EntityType<LilytadEntity>> LILYTAD = ENTITY_TYPES.register("lilytad", () -> FabricEntityType.Builder.createMob(LilytadEntity::new, MobCategory.CREATURE, builder -> builder.spawnPlacement(SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, LilytadEntity::checkLilytadSpawnRules)).sized(0.7f, 1.02f).build(entityKey("lilytad")));
    ...
    public static final CNBRegistrySupplier<EntityType<MinipadEntity>> MINIPAD = ENTITY_TYPES.register("minipad", () -> FabricEntityType.Builder.createMob(MinipadEntity::new, MobCategory.CREATURE, builder -> builder.spawnPlacement(SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, MinipadEntity::checkMinipadSpawnRules)).sized(0.6f, 0.7f).build(entityKey("minipad")));
    ...
    public static final CNBRegistrySupplier<EntityType<CactemEntity>> CACTEM = ENTITY_TYPES.register("cactem", () -> EntityType.Builder.of(CactemEntity::new, MobCategory.CREATURE).sized(0.75F, 1.0F).build(entityKey("cactem")));
